  ...
  return (
    <section className="relative flex flex-1 items-center justify-center py-20">
      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="bg-gradient-to-br from-yellow-400/60 to-orange-400/70 backdrop-blur-sm rounded-2xl p-8 mb-6 shadow-2xl">
          <h1 className="bg-gradient-to-r from-amber-200 to-fuchsia-300 bg-clip-text text-transparent text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold font-serif leading-tight text-shadow">
            {heroSection.title}
          </h1>
        </div>
